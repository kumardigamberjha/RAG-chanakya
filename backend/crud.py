...
crud.py
~~~~~~~
Thin CRUD helpers for subjects – raw SQLite (no ORM session needed here).
Kept separate so main.py stays clean.
"""
...
_DB_PATH = os.environ.get("DB_PATH", os.path.join(os.path.dirname(__file__), "chats.db"))
